...
module.exports = {
    ...
    ,Qcity: function(request, response){
        console.log("\n-_____________________________Qcity________________________________-\n");
        response.send({
                "ret": true,
                "data":{
                    "hotCities": [{
    ...
    , Qdetail: function (request, response) {
        console.log('\n-_____________________________Qdetail________________________________-\n');
        var id = request.query.id || 1;
        console.log(id);
        //没有查数据库，直接将json数据返回
        response.send({
                'ret': true,
    ...
    , Qindex: function (request, response) {
        console.log('\n-_____________________________Qindex________________________________-\n');
